...
NODE_VERSION="20"
REPO_URL="https://github.com/yudiz-solutions/Ludo-Naresh-Game-Backend-manual/"  # Replace with your GitHub repository URL
...
PM2_NAME="classic-manual-mode-stag"
LOG_MAX_SIZE="70M"
LOG_RETAIN_DAYS="7"
BRANCH="timer-mode"  # Variable to specify the branch to clone
S3_BUCKET="s3://ludo-env-bucket/stag-classic_manual"  # Replace with your S3 bucket and folder path
ENV_FILE_NAME="stag-classic_manual-env"  # Name of the env file in the S3 bucket
