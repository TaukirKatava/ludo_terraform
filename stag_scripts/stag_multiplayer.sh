...
NODE_VERSION="20"
REPO_URL="https://github.com/yudiz-solutions/Ludo-Naresh-Classic-multiplayer-BE"  # Replace with your GitHub repository URL
...
PM2_NAME="multiplayer-mode-stag"
LOG_MAX_SIZE="70M"
LOG_RETAIN_DAYS="7"
BRANCH="timer-mode"  # Variable to specify the branch to clone
S3_BUCKET="s3://ludo-env-bucket/stag-multiplayer"  # Replace with your S3 bucket and folder path
ENV_FILE_NAME="stag-multiplayer-env"  # Name of the env file in the S3 bucket
