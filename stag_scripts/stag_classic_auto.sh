...
S3_BUCKET="s3://ludo-env-bucket/stag-classic_auto"  # Replace with your S3 bucket and folder path
ENV_FILE_NAME="stag-classic_auto-env"  # Name of the env file in the S3 bucket
